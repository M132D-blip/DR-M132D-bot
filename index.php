...
$chall = "DRSMS_VIP";
$useradmin = "M132D";
$sim =-1003314033896; #القناة الرسمية
$PAY =-1003512300985; #الارقام المكتملة
$ess =-1003322886589; #عمليات شراء الارقام
$eer =-1003663913368; #اشعارات الايميلات وتحويل الروبل
if($chat_id==1879396098){
$sudo=$chat_id;
}elseif($chat_id==1879396098){
$sudo=$chat_id;
}else{
$sudo==1879396098;
}
...
*- في بوت @M_132D* ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
- لفحص الرقم, أضغط على زر *رؤية الرقم في واتسأب* بعد شراء الرقم, سيقوم بتوجيهك إلى الواتساب, في حالة قال لك *إن رقم الهاتف هذا +967••• @M_132D ليس في واتسأب* هذا يعني أن الرقم جديد ولم يستخدم في واتسأب من قبل, *أما في الحالات الأخرى فهذا يعني أن الرقم مستخدم في واتسأب ولا نتحمل مسؤولية تفعيلة في أي حال من الأحوال.*
...
'text'=>"
👨‍✈️ *⁞ مرحبا بك* [$first](tg://user?id=$id) ؛
🏛 *⁞ هذه تفاصيل حسابك في بوت. @M_132D* ⬇️
...
'message_id'=>$message_id,
'text'=>"
🧑‍✈️ *- أهلا بك عزيزي العميل* في قسم وكلاء البوت الرسميين في بوت *@M_132D* ☑️
",
'parse_mode'=>"MarkDown",
'reply_markup'=>($keyboad),
]);
